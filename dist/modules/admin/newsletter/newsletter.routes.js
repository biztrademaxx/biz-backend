...
router.get("/categories", auth_middleware_1.requireAdmin, newsletter_controller_1.adminListNewsletterCategories);
router.get("/recipient-preview", auth_middleware_1.requireAdmin, newsletter_controller_1.adminPreviewNewsletterRecipients);
